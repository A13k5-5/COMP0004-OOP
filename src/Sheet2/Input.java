 ...
 * catch the exception.
 * </p>
 * <p> Sheet1.Input is buffered meaning that an entire line of text is read into a buffer and then an attempt is
...
public class Input implements Closeable, Iterator<String> {
    ...
    /**
     * The default constructor of an <code>Sheet1.Input</code> that assumes <code>System.in</code> is to
    ...
    /**
     * Constructor of an <code>Sheet1.Input</code> object given an <code>InputStream</code> object.
     */
    ...
    /**
     * Constructor of an <code>Sheet1.Input</code> object given a <code>Readable</code> object.
     */
    ...
    /**
     * Constructor of an <code>Sheet1.Input</code> object given a <code>Scanner</code> object.
    ...
    // Sheet1.Input can be of any of the types supported by the class.
    ...
    private void handleInputMismatchException(String type) {
        System.err.println("InputMismatchException: Sheet1.Input does not match expected " + type + " type.");
    }
