 ...
 * <code>Input</code> that hides the exceptions that can happen when opening a
 * file. As with
 * <code>Input</code> all errors during use of the iterator result in a message
 * output to the
 * standard error and default values returned.
 * <p/>
 * <p>
 * This class is useful for people new to Java since it allows them to write
 * programs using
 * input from a file without having to fully understand the read / parse /
 * handle exceptions model
...
public class FileInput extends Input {
     ...
     * If the file cannot be opened a message is output to standard error and the
     * program
     * using FileInput is allowed to continue running. However, the program will be
     * a potentially
